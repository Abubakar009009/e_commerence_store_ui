...
import 'package:e_commerence_store_ui/views/show_all_products_admin.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DrawerRow(imagelink: AppAssets.drawerbag, text: 'Orders History'),
            const SizedBox(
              height: 20,
            ),
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ShowAllProductsAdmin()),
                );
              },
              child: DrawerRow(
                  imagelink: AppAssets.drawerWallet, text: 'All Products'),
            ),
            const SizedBox(
              height: 20,
            ),
