...
class AppConstants {
  ...
  static List<BrandModel> brandList = [
    // BrandModel(
    //     name: 'Adidas',
    //     imageLink: 'assets/images/Adidas.jpg'), /////https://ibb.co/Wv1HxWv
    // BrandModel(name: 'Nike', imageLink: 'assets/images/Nike.jpg'),

    // ///https://ibb.co/V9XSrJs
    // BrandModel(
    //     name: 'Fila',
    //     imageLink: 'assets/images/fila.jpg'), //////https://ibb.co/Y2c9zM8
  ];
  ...
  // static List<ProductsModel> productsL = [
  //   ProductsModel(
  //       name: 'Adidas',
  //       imageLink: [
