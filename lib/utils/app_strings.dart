class AppStrings {
  static String lookgood = 'Look Good, Feel Good';
  ...
  static String usernameheading = 'Username';

  static String usernamehint = 'Enter Username';
  static String passwordheading = 'Password';

  static String passwordhint = 'Enter Password';
  static String emailheading = 'Email Address';

  static String emailhint = 'Enter Your Mail';
  ...
  static String enterData = 'Please enter your data to continue';
  static String forgotPassword = 'Forgot Password?';
  static String agree =
      'By connecting your account confirm that you agree with our';
  static String termsandConditions = ' Term and Condition';
  static String login = 'Login';
  //////////////////////////screen 5 /////////////////////////
  static String emailValidation =
      'Please write your email to receive a confirmation code to set a new password.';
  static String confirmmail = 'Confirm Mail';
/////////screen 6

  static String timer = '00:20';
  static String confirmation = '  resend confirmation code.';
  static String confirmcode = 'Confirm Code';

  //////////////////////////screen 7 /////////////////////////
  static String newPassword = 'New Password';
  static String newPasswordtext = 'Please write your new password';
  static String resetPassword = 'Reset Password';

  ///////////screen8///////
  static String hello = 'Hello';
  static String wellcome = 'Welcome to Laza.';
  static String brand = 'Choose Brand';
  static String viewAll = 'View All';
  static String newArrivals = 'New Arrivals';
  /////////screen9
  static String price = 'Price';
  static String size = 'Size';
  static String sizeGuide = 'Size Guide';
  static String description = 'Description';
  static String reviews = 'Reviews';
  static String totalPrice = 'Total Price';
  static String addtoCart01 = 'Add to Cart';

  static String vatSD = 'with VAT,SD';

  static String addReviewButton = 'Add Review';
  static String name01 = 'Name';
